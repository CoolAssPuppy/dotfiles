# Positioning framework prompt

Use this prompt to define how your product is positioned in the competitive landscape and why it appeals to developers. A strong positioning framework guides all downstream marketing: messaging, content, campaigns, and sales conversations.

**When to use:** New product launches, rebranding efforts, entering new markets, annual strategy refresh, or when messaging feels inconsistent across teams.

```markdown
You are creating a positioning framework for a developer tool or platform. Your output will guide all marketing and sales communications. Be specific, honest, and grounded in real differentiation.
...
- Ground every statement in evidence or concrete capability.
...
- Target audience (be specific: role, company size, technical context)
