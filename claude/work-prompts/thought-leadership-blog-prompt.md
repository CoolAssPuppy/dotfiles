...
1. Open with a bold, clear thesis that establishes scope. Tell readers immediately what this post is about and why it matters.
...
- Keep paragraphs varied in length for pacing
- Link to references naturally within sentences rather than as footnotes
- Aim for 2,000-3,000 words for substantial topics

## What NOT to do

- Do not use emdashes. Use commas, periods, or semicolons instead.
- Do not use emoji or line separators.
- Do not use grandiose language: avoid "stands as a testament," "plays a vital role," "underscores its importance," "in today's rapidly evolving landscape"
- Do not overuse the rule of three in every paragraph
- Do not use hedging phrases: "it's important to note that," "generally speaking," "from a broader perspective"
- Do not use trailing participle clauses: "emphasizing the importance of," "reflecting the continued relevance of"
- Do not use marketing adjectives: "cutting-edge," "revolutionary," "game-changing," "seamless," "robust"
- Do not use "delve," "explore," "crucial," "foster," "leverage," "utilize," "facilitate"
- Do not start sentences with "This" referring vaguely to the previous paragraph
- Do not end with generic calls to action or summary paragraphs that repeat what you already said
